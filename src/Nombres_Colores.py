from src.Dic_Color import Colores
...
class Clasificacion_Colores():
    
    def clasificacion(self, lista_Caracteristicas, colores):
        
        codigo = []
        for color in colores:
            id_ = Nombres.get(color[0])
            codigo.append(id_)
        
        colores = Colores()
        valores = colores.clasificar_Colores(lista_Caracteristicas, codigo)
        return valores 